    ...
    return (
        <div className="w-full h-20 shadow-navbarShadow lg:h=[12vh] sticky top-0 z-60 bg-bodyColor px-4 z-300 navbar">
            <div className="flex max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between ">
                <motion.div initial={{ opacity: 1 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                    {/* <Image className="w-14" src={logo} alt="logo"></Image> */}
                </motion.div>
                <div className="hidden mdl:inline-flex items-center gap-7">
                    <ul className="flex text-[13px] gap-7 align-items">
                        <Link href="#home" onClick={handleScroll} className="flex item-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <li>Home</li>
                        </Link>
                        <Link href="#about" onClick={handleScroll} className="flex item-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <span>01.</span><li> About</li>
                        </Link>
                        <Link href="#work" onClick={handleScroll} className="flex item-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <span>02.</span><li> Experience</li>
                        </Link>
                        <Link href="#project" onClick={handleScroll} className="flex item-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <span>03.</span><li> Work</li>
                        </Link>
                        <Link href="#contact" onClick={handleScroll} className="flex item-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            ...
                            <motion.div
                                ...
                                <div className="flex flex-col items-center gap-7">
                                    <ul className="flex flex-col text-base gap-7 ">
                                        <Link className="flex flex-col text-base gap-7" href="#home" onClick={handleScroll}>
                                            <motion.li
                                                initial={{ x: 20, opacity: 0 }}
